...
private:
    ...
    void PromoteAllWhitelistWindows();
    void RestoreAllWhitelistWindows();
    ...
    static BOOL CALLBACK EnumWhitelistedWindowsForPromote(HWND window, LPARAM param);
